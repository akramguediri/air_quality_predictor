...
results = pd.DataFrame({
    ...
    'Main_AQI': [future_predictions[0][0]],
    'CO': [future_predictions[0][1]],
    'NO': [future_predictions[0][2]],
    'NO2': [future_predictions[0][3]],
    'O3': [future_predictions[0][4]],
    'SO2': [future_predictions[0][5]],
    'PM2.5': [future_predictions[0][6]],
    'PM10': [future_predictions[0][7]]
})
